...
namespace Ecommerce.API.Transformers;
...
internal sealed class BearerSecuritySchemeTransformer(Microsoft.AspNetCore.Authentication.IAuthenticationSchemeProvider authenticationSchemeProvider) : IOpenApiDocumentTransformer
{
    public async Task TransformAsync(OpenApiDocument document, OpenApiDocumentTransformerContext context, CancellationToken cancellationToken)
    {
        ...
        if (authenticationSchemes.Any(authScheme => authScheme.Name.Contains("Bearer")))
        {
            Dictionary<string, OpenApiSecurityScheme> requirements = new Dictionary<string, OpenApiSecurityScheme>
            {
